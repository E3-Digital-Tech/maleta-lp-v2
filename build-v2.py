...
stage = '''<section class="stage" id="stage1" style="height:200vh">
  <div class="pin">
    ...
    <div class="blk blk--l" data-w="0,1">
      <h1 class="h-xl ttl">Tudo o que seu escritório precisa para transformar <span class="hl">oportunidades em contratos,</span> dentro de <span class="hl">uma única maleta.</span></h1>
